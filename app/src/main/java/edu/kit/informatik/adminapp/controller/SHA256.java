...
/**
 * This class provides an implementation of the SHA-256 algorithm for hashing strings.
 *
 * Note: The methods in this class are taken from https://www.baeldung.com/sha-256-hashing-java.
 */
